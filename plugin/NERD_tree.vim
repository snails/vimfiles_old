...
"
" ============================================================================
let s:NERD_tree_version = '3.1.0 [huacnlee]'
...
call s:initVariable("g:NERDTreeMapCloseChildren", "")
call s:initVariable("g:NERDTreeMapCloseDir", "")
...
call s:initVariable("g:NERDTreeMapOpenExpl", "")
call s:initVariable("g:NERDTreeMapOpenInTab", "")
call s:initVariable("g:NERDTreeMapOpenInTabSilent", "")
call s:initVariable("g:NERDTreeMapOpenRecursively", "")
call s:initVariable("g:NERDTreeMapOpenSplit", "")
call s:initVariable("g:NERDTreeMapOpenVSplit", "")
call s:initVariable("g:NERDTreeMapPreview", "" . NERDTreeMapActivateNode)
call s:initVariable("g:NERDTreeMapPreviewSplit", "" . NERDTreeMapOpenSplit)
call s:initVariable("g:NERDTreeMapPreviewVSplit", "" . NERDTreeMapOpenVSplit)
call s:initVariable("g:NERDTreeMapQuit", "")
...
call s:initVariable("g:NERDTreeMapUpdirKeepOpen", "")

"SECTION: Script level variable declaration{{{2
let s:escape_chars =  " \\`\|\"#%&,?()\*^<>"
let s:NERDTreeBufName = 'NERD tree '
    ...
    if winnr != -1
        ...
        if !s:isWindowUsable(winnr("#")) && s:firstNormalWindow() ==# -1
            ...
            try
                ...
                call s:Warn("[Notice] Current file already modified. You need save it, before open new buffer!")
...
function! s:dumpHelp()
    let old_h = @h
    if b:treeShowHelp ==# 1
        let @h=   "\" NERD tree " . s:NERD_tree_version . " ~\n"
        let @h=@h."\" ============================\n"
        let @h=@h."\" ". g:NERDTreeMapActivateNode .": open,open/close Dir )\n"
        let @h=@h."\" ". g:NERDTreeMapChangeRoot .": set as Root\n"
        "let @h=@h."\" ". g:NERDTreeMapOpenInTab.": open in new tab\n"
        let @h=@h."\" ". g:NERDTreeMapRefresh .": refresh dir (R for root)\n"
        let @h=@h."\" ". g:NERDTreeMapFilesystemMenu .": File menu (create file/dir)\n"
        ...
        let @h=@h."\" ". g:NERDTreeMapDeleteBookmark .": remove Bookmark\n"

        let @h=@h."\" ". g:NERDTreeMapJumpParent .": go to parent\n"
        let @h=@h."\" ". g:NERDTreeMapJumpFirstChild  .": first node\n"
        let @h=@h."\" ". g:NERDTreeMapJumpLastChild   .": last node\n"

        let @h=@h."\" ". g:NERDTreeMapChdir .":change the CWD to the\n"

        let @h=@h."\" Options -----------------------~\n"
        let @h=@h."\" ". g:NERDTreeMapToggleHidden .": hidden files(" . (b:NERDTreeShowHidden ? "on" : "off") . ")\n"
        let @h=@h."\" ". g:NERDTreeMapToggleFilters .": filters(" . (b:NERDTreeIgnoreEnabled ? "on" : "off") . ")\n"
        let @h=@h."\" ". g:NERDTreeMapToggleFiles .": only show dir(" . (b:NERDTreeShowFiles ? "on" : "off") . ")\n"
        let @h=@h."\" ". g:NERDTreeMapToggleBookmarks .": bookmarks(" . (b:NERDTreeShowBookmarks ? "on" : "off") . ")\n"

        let @h=@h."\" ". g:NERDTreeMapHelp .": open/close help\n"
        let @h=@h."\"\n\" ----------------------------\n"
